...
const translations = {
  ...
  de: {
    ...
    'map-layer-ticket-sales-machine': 'Fahrkartenautomaten',
    'map-layer-ticket-sales-point': 'Fahrkartenverkaufspunkte',
    ...
    'route-prefer-greenways': 'Fahrradwege bevorzugen',
    'route-prefer-illuminated': 'Beleuchtete Wege bevorzugen',
    'route-prefer-paved': 'Asphaltierte Strecken bevorzugen',
    'route-prefer-walking-routes': 'Bevorzuge Fußwege',
    'route-prefer-winter-maintenance': 'Bevorzuge Routen mit Winterdienst',
    'route-preferences': 'Routing-Einstellungen',
    'route-public-transport-with-bicycle': 'ÖPNV mit Fahrrad',
    'route-saved-settings': 'Einstellungen speichern',
    ...
    'settings-loadbutton': 'Einstellungen laden',
  ...
  en: {
    ...
    'copy-link-to-clipboard-copied': 'Copied!',
    ...
    send: 'Send',
    'send-email-modal-input-label': 'Email address',
    'send-email-modal-input-placeholder': 'Enter email...',
    'send-email-modal-submit': 'Send link',
    'send-email-modal-title': 'Send link to buy route on your phone',
    'separate-ticket-required':
  ...
  es: {
    ...
    continue: 'Jatka',
    'copy-link-to-clipboard': 'Kopioi linkki',
    'copy-link-to-clipboard-copied': 'Linkki kopioitu!',
    ...
    send: 'Lähetä',
    'send-email-modal-input-label': 'Sähköpostiosite',
    'send-email-modal-input-placeholder': 'Syötä sähköpostiosoite...',
    'send-email-modal-submit': 'Lähetä',
    'send-email-modal-title': 'Lähetä linkki puhelimeesi',
    'separate-ticket-required':
  ...
  ro: {
    ...
    bicycle: 'Bicicletă',
    'bicycle-distance-duration': 'Bicicletă {distance} ({duration})',
    ...
    car: 'Mașină',
    'car-distance-duration': 'Condu {distance} ({duration})',
    car_park: 'park & ride',
    cause: 'cauză',
    'char-left': 'caractere',
    ...
    'footer-feedback': 'Spuneți-vă părerea',
    'footer-link-to-privacy-policy': 'Politica de confidențialitate',
    ...
    'map-layer-ticket-sales-machine': 'Automate de bilete',
    'map-layer-ticket-sales-point': 'Puncte de încărcare a cardurilor',
    'map-layer-vehicles': 'Vehicles',
    ...
    'no-favourite-locations':
      'Adaugăți aici cele mai utilizate destinații pentru a vă planifica rutele printr-o singură apăsare de buton.',
    'no-favourites':
      'Folosiți butonul „steluță” pentru a adăuga locații ca favorite. Ele vor apărea aici.',
    ...
    'route-page.title': 'Ruta {shortName}',
    'route-page.title-short': 'Ruta',
    'route-prefer-greenways': 'Preferați pistele de biciclete',
    'route-prefer-illuminated': 'Preferați rutele iluminate',
    'route-prefer-paved': 'Preferați rutele asfaltate (pavate)',
    'route-prefer-walking-routes': 'Preferați rutele desemnate de mers pe jos',
    'route-prefer-winter-maintenance': 'Preferați rutele întreținute iarna',
    'route-preferences': 'Preferințe privind rutele',
    'route-public-transport-with-bicycle': 'Transport public cu bicicleta',
    'route-saved-settings': 'Setări salvate',
    'route-stop-or-keyword': 'Despre rută sau stație',
    routes: 'Rute',
    ...
    'settings-loadbutton': 'Încarcă setări',
    'settings-loaded': 'Setări încărcate!',
    'settings-reset': 'Resetare la setările implicite',
    'settings-savebutton': 'Salvare setări',
    ...
    'splash-choose': 'Specificați punctul de plecare',
    ...
    walk: 'mers pe jos',
    'walk-distance-duration': 'Mergeți pe jos {distance} ({duration})',
  ...
  sv: {
    ...
    continue: 'Fortsätt',
    'copy-link-to-clipboard': 'Kopiera länken',
    'copy-link-to-clipboard-copied': 'Kopierad!',
    ...
    'pick-mode-selected': 'Valda transportlägen',
